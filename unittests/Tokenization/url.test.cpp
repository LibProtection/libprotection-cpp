...
TEST_CASE("Url") {
  SECTION("https://user:password@host.domain/path/to/document/?a=1&b=2#fragment") {
    ...
    REQUIRE(13 == tokens[4].range.upperBound);
    ...
    REQUIRE(21 == tokens[5].range.upperBound);
    ...
    REQUIRE(22 == tokens[6].range.upperBound);
    ...
    REQUIRE(38 == tokens[9].range.upperBound);
    ...
    REQUIRE(53 == tokens[16].range.upperBound);
    ...
    REQUIRE(54 == tokens[17].range.upperBound);
    ...
    REQUIRE(55 == tokens[18].range.upperBound);
    ...
    REQUIRE(56 == tokens[19].range.upperBound);
    ...
    REQUIRE(57 == tokens[20].range.upperBound);
    ...
    REQUIRE(58 == tokens[21].range.upperBound);
    ...
    REQUIRE(59 == tokens[22].range.upperBound);
    ...
    REQUIRE(60 == tokens[23].range.upperBound);
    ...
    REQUIRE(68 == tokens[24].range.upperBound);
  ...
  SECTION("Assets/jsFile.js") {
    ...
    REQUIRE(0 == tokens[0].range.lowerBound);
    REQUIRE(6 == tokens[0].range.upperBound);
    ...
    REQUIRE(16 == tokens[2].range.upperBound);
