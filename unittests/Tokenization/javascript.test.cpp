...
TEST_CASE("JavaScript") {
  SECTION("JavaScript1") {
    ...
    REQUIRE(4 == tokens[1].range.upperBound);
    ...
    REQUIRE(5 == tokens[2].range.upperBound);
    ...
    REQUIRE(6 == tokens[3].range.upperBound);
    ...
    REQUIRE(15 == tokens[10].range.upperBound);
    ...
    REQUIRE(16 == tokens[11].range.upperBound);
    ...
    REQUIRE(17 == tokens[12].range.upperBound);
    ...
    REQUIRE(18 == tokens[13].range.upperBound);
    ...
    REQUIRE(19 == tokens[14].range.upperBound);
    ...
    REQUIRE(26 == tokens[20].range.upperBound);
    ...
    REQUIRE(27 == tokens[21].range.upperBound);
    ...
    REQUIRE(28 == tokens[22].range.upperBound);
    ...
    REQUIRE(29 == tokens[23].range.upperBound);
    ...
    REQUIRE(30 == tokens[24].range.upperBound);
    ...
    REQUIRE(31 == tokens[25].range.upperBound);
    ...
    REQUIRE(39 == tokens[30].range.upperBound);
    ...
    REQUIRE(48 == tokens[31].range.upperBound);
    ...
    REQUIRE(49 == tokens[32].range.upperBound);
    ...
    REQUIRE(50 == tokens[33].range.upperBound);
    ...
    REQUIRE(51 == tokens[34].range.upperBound);
    ...
    REQUIRE(54 == tokens[37].range.upperBound);
  ...
  SECTION("JavaScript2") {
    ...
    REQUIRE(25 == tokens[2].range.upperBound);
    REQUIRE(TOKEN_TYPE(JavaScriptTokenType::Identifier) == tokens[2].tokenType);

    REQUIRE(" " == tokens[3].text);
    REQUIRE(25 == tokens[3].range.lowerBound);
    REQUIRE(26 == tokens[3].range.upperBound);
    REQUIRE(TOKEN_TYPE(JavaScriptTokenType::WhiteSpaces) == tokens[3].tokenType);

    REQUIRE("=" == tokens[4].text);
    REQUIRE(26 == tokens[4].range.lowerBound);
    REQUIRE(27 == tokens[4].range.upperBound);
    REQUIRE(TOKEN_TYPE(JavaScriptTokenType::Assign) == tokens[4].tokenType);
    ...
    REQUIRE(66 == tokens[6].range.upperBound);
    ...
    REQUIRE(67 == tokens[7].range.upperBound);
