...
TEST_CASE("Html") {
  ...
  SECTION("general") {
    ...
    REQUIRE(15 == tokens[4].range.upperBound);
    ...
    REQUIRE(42 == tokens[10].range.upperBound);
    ...
    REQUIRE(43 == tokens[11].range.upperBound);
    ...
    REQUIRE(59 == tokens[15].range.upperBound);
    ...
    REQUIRE(64 == tokens[16].range.upperBound);
    ...
    REQUIRE(65 == tokens[17].range.upperBound);
    ...
    REQUIRE(84 == tokens[21].range.upperBound);
    ...
    REQUIRE(85 == tokens[22].range.upperBound);
    ...
    REQUIRE(106 == tokens[27].range.upperBound);
    ...
    REQUIRE(107 == tokens[28].range.upperBound);
    ...
    REQUIRE(113 == tokens[29].range.upperBound);
    ...
    REQUIRE(114 == tokens[30].range.upperBound);
    ...
    REQUIRE(120 == tokens[31].range.upperBound);
    ...
    REQUIRE(121 == tokens[32].range.upperBound);
    ...
    REQUIRE(127 == tokens[33].range.upperBound);
    ...
    REQUIRE(128 == tokens[34].range.upperBound);
    ...
    REQUIRE(134 == tokens[35].range.upperBound);
    ...
    REQUIRE(135 == tokens[36].range.upperBound);
    ...
    REQUIRE(146 == tokens[37].range.upperBound);
    ...
    REQUIRE(155 == tokens[38].range.upperBound);
    ...
    REQUIRE(156 == tokens[39].range.upperBound);
    ...
    REQUIRE(162 == tokens[40].range.upperBound);
    ...
    REQUIRE(163 == tokens[41].range.upperBound);
    ...
    REQUIRE(170 == tokens[42].range.upperBound);
    ...
    REQUIRE(171 == tokens[43].range.upperBound);
    ...
    REQUIRE(173 == tokens[44].range.upperBound);
    ...
    REQUIRE(177 == tokens[45].range.upperBound);
  ...
  SECTION("general1") {
    ...
    REQUIRE(7 == tokens[1].range.upperBound);
    ...
    REQUIRE(9 == tokens[3].range.lowerBound);
    REQUIRE(21 == tokens[3].range.upperBound);
    ...
    REQUIRE(30 == tokens[4].range.upperBound);
    ...
    REQUIRE(31 == tokens[5].range.upperBound);
    ...
    REQUIRE(78 == tokens[10].range.upperBound);
    ...
    REQUIRE(84 == tokens[11].range.upperBound);
    ...
    REQUIRE(85 == tokens[12].range.upperBound);
    ...
    REQUIRE(90 == tokens[13].range.upperBound);
    ...
    REQUIRE(92 == tokens[14].range.upperBound);
    ...
    REQUIRE(113 == tokens[15].range.upperBound);
  ...
  SECTION("unclosed-quotes") {
    ...
    REQUIRE(5 == tokens[1].range.lowerBound);
    REQUIRE(10 == tokens[1].range.upperBound);
    REQUIRE(TOKEN_TYPE(HtmlTokenType::AttributeName) == tokens[1].tokenType);

    REQUIRE("=" == tokens[2].text);
    REQUIRE(10 == tokens[2].range.lowerBound);
    REQUIRE(11 == tokens[2].range.upperBound);
    REQUIRE(TOKEN_TYPE(HtmlTokenType::TagEquals) == tokens[2].tokenType);

    REQUIRE("'" == tokens[3].text);
    REQUIRE(11 == tokens[3].range.lowerBound);
    REQUIRE(12 == tokens[3].range.upperBound);
    ...
    REQUIRE(28 == tokens[6].range.upperBound);
    ...
    REQUIRE(39 == tokens[10].range.upperBound);
    ...
    REQUIRE(58 == tokens[14].range.upperBound);
    ...
    REQUIRE(68 == tokens[17].range.upperBound);
  ...
  SECTION("unclosed-tag") {
    ...
    REQUIRE(11 == tokens[3].range.lowerBound);
    REQUIRE(24 == tokens[3].range.upperBound);
    ...
    REQUIRE(29 == tokens[5].range.upperBound);
